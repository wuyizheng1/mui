...
/***/ function(module, exports, __webpack_require__) {
	...
	var donghua = __webpack_require__(14);
	...
	$("#enter").tap(function () {
	 ...
	 // localStorage.getbendi = true; //存入到local中
	  ...
	  $.post('http://1.1373938632.applinzi.com/www/' + 'db.json', {
	    am1: 'value1'
	...
	$("footer>div").not("#meone").tap(function () {
	  ...
	  // alert(tar)
	  $.get('http://1.1373938632.applinzi.com/www/' + 'db.json', { //www下需要用到post 去找 但是这里面还需要用到get获取本地
	    param1: 'value1'
	    ...
	    switch (tar) {
	      case "skill":
	        ...
	        break;
	      case "project":
	        var data = data1.project;
	        for (var i = 0; i < 1; i++) {

	          str += '<li id="xiangmu"><div><img src="img/gongsi.jpg"></div><ul class="ultwo"><li>' + data[i].name + '</li><li class="miaoshu">描述:' + data[i].description + '</li ><img src="img/yijiao.jpg"><li class="xiangqing">详情:' + data[i].detail + ',</li><li>技术:' + data[i].tech + '...</li></ul></li>';
	        };
	        $(".ulone").html(str);
	        break;
	...
	$(".me").tap(function () {
	  ...
	  str += "<div id='me'><h1>自我介绍</h1><p>姓名:&nbsp;&nbsp;&nbsp;吴义正</p><p>毕业院校:&nbsp;&nbsp;黄山学院</p><p>学历:  本科</p><p>爱好: 看书,广泛,珍惜时间</p><div><img src='img/shijian.jpg'></div><h2>格言</h2><div class='pzong'><p>青春不是年华，而是心境；青春不是桃面、丹唇、柔膝，而是深沉的意志、恢宏的想象、炽热的感情；青春是生命的深泉在涌流.</p><p>青春气贯长虹，勇锐盖过怯弱，进取压倒苟安。如此锐气，二十后生有之，六旬男子则更多见。年岁有加，并非垂老；理想丢弃，方堕暮年。岁月悠悠，衰微只及肌肤；热忱抛却，颓唐必至灵魂。忧烦、惶恐、丧失自信，定使心灵扭曲，意气如灰。</p><p>无论年届花甲，抑或二八芳龄，心中皆有生命之欢乐，奇迹之诱惑，孩童般天真久盛不衰。 人人心中皆有一台天线，只要你从天上人间接受美好、希望、欢乐、勇气和力量的信号，你无不青春永驻、风华长存。 </p><p>一旦天线降下，锐气便被冰雪覆盖，玩世不恭、自暴自弃油然而生，即便年方二十，实已垂垂老矣；然则只要竖起天线，捕捉乐观信号，你就有望在八十高龄告别尘寰时仍觉年轻</p></div></div>";
    ...
    $(".img1").tap(function () {
           $.post('../www/php/getsign.php',{
           url:window.location.href 
         },function(text,status){
        	//从效过果上看ajax获取的永远是页面的源代码而非页面的内容提取所需要的obj;
	    ...
	    var e = function (e) {
	      ...
	      var r = [],
	        ...
	        var s,
	          ...
	          var l = "div";for (0 === o.indexOf("<li") && (l = "ul"), 0 === o.indexOf("<tr") && (l = "tbody"), (0 === o.indexOf("<td") || 0 === o.indexOf("<th")) && (l = "tr"), 0 === o.indexOf("<tbody") && (l = "table"), 0 === o.indexOf("<option") && (l = "select"), n = document.createElement(l), n.innerHTML = a, i = 0; i < n.childNodes.length; i++) r.push(n.childNodes[i]);
	        } else for (s = t || "#" !== a[0] || a.match(/[ .<>:~]/) ? (t || document).querySelectorAll(a) : [document.getElementById(a.split("#")[1])], i = 0; i < s.length; i++) s[i] && r.push(s[i]);
	      } else if (a.nodeType || a === window || a === document) r.push(a);else if (a.length > 0 && a[0].nodeType) for (i = 0; i < a.length; i++) r.push(a[i]);return new e(r);
